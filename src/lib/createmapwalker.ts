...
class CMapWalker {
  ...
  constructor(position: any) {
    ...
    this.angleBack = document.createElement("div");
    this.content.className = "MapWalker";
    this.figure.className = "figure";
    this.angleBack.className = "angleBack";
    this.content.appendChild(this.angleBack);
    this.content.appendChild(this.figure);
    this.walker = new (window as any).kakao.maps.CustomOverlay({
      position: position,
